    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent 
        ...
        className={cn(
          ...
          // Dynamic margin based on document state
          document.querySelector('aside[data-state="open"]') ? "ml-[240px]" : "ml-[72px]"
        )}
      >
        <div className="sticky top-0 z-10 bg-inherit pt-6 px-6 pb-2 border-b">
          ...
          >
            <TabsList className="w-full grid grid-cols-4">
              <TabsTrigger value="appInfo">App Information</TabsTrigger>
              <TabsTrigger value="programSettings">Program Settings</TabsTrigger>
              <TabsTrigger value="postInstall">Post Install Settings</TabsTrigger>
              <TabsTrigger value="scripts">Pre & Post Script</TabsTrigger>
            </TabsList>
          </Tabs>
        </div>

        <div className="p-6">
          <TabsContent value="appInfo" className="mt-0">
          ...
          <TabsContent value="programSettings" className="mt-0">
            <div className="space-y-4">
              <div>
          ...
          <TabsContent value="postInstall" className="mt-0">
            <div className="space-y-4">
              <div>
